  ...
  return (
    <Section.Wrapper>
      <Section.Content
        ...
        description={
          <>
            This website is operated by ForeverSoleMates. Throughout the site,
            the terms “we”, “us” and “our” refer to ForeverSoleMates.
            ForeverSoleMates offers this website, including all information,
      ...
      <Section.Content
        ...
        description={
          <>
            ...
            non-infringement.
            <br />
            In no case shall ForeverSoleMates, our directors, officers,
      ...
      <Section.Content
        ...
        description={
          <>
            You agree to indemnify, defend and hold harmless ForeverSoleMates
      ...
      <Section.Content
        ...
        description={
          <>
            ...
            info@foreversolemates.com.
          </>
        }
      />
      <Section.Content
        header="SECTION 21 - MARKETING"
        description={
          <>
            By consenting to ForeverSoleMates` SMS marketing in the checkout and
            ...
            messages and notifications, reply with STOP to any mobile message
            sent from us or use the unsubscribe link we provided you within any
            of our messages. You understand and agree that alternative methods
            of opting out, such as using alternative words or requests, will not
            be considered a reasonable means of opting out. We do not charge for
            ...
            <br /> For any questions, please text HELP to the number you
            received the messages from. You can also contact us for more
            information. We have the right to modify any telephone number or
            short code we use to operate the service at any time. You will be
            notified on such occasions. You agree that any messages you send to
            a telephone number or short code we have changed, including any STOP
            or HELP requests, may not be received, and we will not be liable for
            honoring requests made in such messages.
            <br /> To the extent permitted by applicable law, you agree that we
            will not be liable for failed, delayed, or misdirected delivery of
            any information sent through the service, any errors in such
            information, and/or any action you may or may not take in reliance
            on the information or Service. Your right to privacy is important to
            us. You can see our Privacy Policy to determine how we collect and
